  ...
  return <div>
    ...
    <form onSubmit={handleSubmit(onSubmit)} >
      <div>
        ...
        <div>
          <Field component='input' type='text' name='name' defaultValue={template.name} placeholder='Название' />
        </div>
      </div>
      <div>
        <label>Заголовок шаблона</label>
        <div>
          <Field component='input' type='text' name='title' defaultValue={template.title} placeholder='Заголовок шаблона' />
        </div>
      </div>
      <div>
        <label>Группы</label>
